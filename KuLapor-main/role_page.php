...
<body>
    ...
    <div class="main-content">
        <span>Halaman Pemilihan Akun</span>
        <h1>LOGIN AKUN KULAPOR</h1>
        <p class="subtitle">Silakan pilih jenis akun yang sesuai dengan peran Anda untuk memulai proses pelaporan KuLapor.</p>

        <div class="button-group">
            <a href="login_siswa.php" class="btn btn"><i class="bi bi-people"></i>Masuk Sebagai Siswa</a>
            <a href="login_admin.php" class="btn btn"><i class="bi bi-person-gear"></i>Masuk Sebagai Administator</a>
        </div>
    </div>
</body>
